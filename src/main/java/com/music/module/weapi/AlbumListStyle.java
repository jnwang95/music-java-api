 ...
 */
@Service
public class AlbumListStyle implements BaseModuleWeApi {
    ...
    public void execute(JSONObject object, Map<String, String> queryMap, Map<String, String> cookies) {
            ...
            object.set("area", StrUtil.nullToDefault(queryMap.get("area"),"Z_H"));
            //Z_H:华语,E_A:欧美,KR:韩国,JP:日本
    }

    @Override
    public String getUrl() {
        return "https://music.163.com/weapi/vipmall/appalbum/album/style";
    }
}
